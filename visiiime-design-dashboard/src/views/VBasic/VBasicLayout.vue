  ...
  <div class="layout">
    <div class="mb-10">
      ...
      <div class="grid grid-cols-3 md:grid-cols-3 lg:grid-cols-4 gap-3">
        <div v-for="layout in layouts" :key="layout.layoutId">
          <div @click="themeChangeLayout(layout)">
            <div class="mobile-frame">
              <mobile-phone-mini
                :preview-image="layout.layoutImage"
                :outter-frame="layout.layoutId === currentThemeLayout.layoutId"
              />
            </div>
    ...
    <div class="mb-10">
          ...
          <div @click="changeBackground(bg.bgName)">
            <div class="mobile-frame">
              <mobile-phone-mini
                ...
                :outter-frame="
                  bg.bgName === customDataBackground.bgName"
              />
            </div>
      ...
      <div class="flex items-center justify-start">
        <color-picker 
          :my-color="customDataBackground.bgColor" 
          :emit-function="'update-background-color'"
    ...
    <div class="mb-10">
      ...
      <div class="flex items-center justify-start">
        <color-picker 
          :my-color="customDataText.textColor" 
          :emit-function="'update-text-color'"
    ...
    <upload-modal
      :emit-function="'update-background-image'"
...
export default {
  ...
  methods: {
    themeChangeLayout({ layoutId, layoutName }) {
      let layout = new LayoutVO(layoutName, layoutId);
      this.currentThemeLayout.layoutName = layout.layoutName;
      this.currentThemeLayout.layoutId = layout.layoutId;
