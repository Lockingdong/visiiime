...
class CreateVUserSubscriptionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('v_user_subscriptions', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('v_user_subscriptions');
    }
}
