    ...
    <div class="flex">
        ...
        <button @click="featureButtonOn = !featureButtonOn" class="relative ml-2 w-30 py-3 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-indigo-500 hover:bg-indigo-400 focus:outline-none">
            ...
            <div
                ...
                style=""
            >
                <div @click="addLinkItem(linkTypeEnum.main, 'main')" tabindex="-1" class="outline-none block px-4 py-2 text-sm text-gray-700">main link</div>
                <div @click="addLinkItem(linkTypeEnum.media, 'normal')" tabindex="-1" class="outline-none block px-4 py-2 text-sm text-gray-700">media link</div>
